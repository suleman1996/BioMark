...
export type CovidBookingListResponse = ApiResponse<CovidBookingListResponseData>
export type CancelCovidBookingResponse = ApiResponse<CancelCovidBookingResponseData>
